...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadMoreActions_requestMoreFromLoader() {
        ...
        sut.simulateLoadMoreFeedAction()
        XCTAssertEqual(loader.loadMoreCallCount, 1, "Expected no requset while loading more")
    ...
    func test_feedImageView_loadsImageURLWhenVisible() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [image0.url], "Expected first image URL reqeuest once first view becomes visible")
    ...
    func test_feedImageView_showDataForNewViewRequestAfterPreviousViewIsReused() throws {
        let (sut, loader) = makeSUT()
    ...
    private func makeSUT(
        ...
        let sut = FeedUIComposer.feedComposedWith(
            ...
            imageLoader: loaderSpy.loadImageDataPublisher,
            selection: selection)
